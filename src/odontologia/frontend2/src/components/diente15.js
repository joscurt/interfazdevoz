...
class CustomForm15 extends Component {
...
if(this.state.finalizar == "medición"){
  return(
    ...
    {  /*onSubmit={(event) => this.handleFormSubmit(event)*/ }
        ...
        <h1>Pieza dental 1.5 por vestibular</h1>
        <img src={require('../images/periodontograma-dientes-arriba-15.png')} />
        <Row gutter={32}>
