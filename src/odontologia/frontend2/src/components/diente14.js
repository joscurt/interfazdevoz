...
class CustomForm14 extends Component {
...
if(this.state.finalizar == "medición"){
  return(
    ...
    {  /*onSubmit={(event) => this.handleFormSubmit(event)*/ }
        ...
        <h1>Pieza dental 1.4 por vestibular</h1>
        <img src={require('../images/periodontograma-dientes-arriba-14.png')} />
        <Row gutter={32}>
