...
class CustomForm17 extends Component {
...
if(this.state.finalizar == "medición"){
  return(
    ...
    {  /*onSubmit={(event) => this.handleFormSubmit(event)*/ }
        ...
        <h1>Pieza dental 1.7 por vestibular</h1>
        <img src={require('../images/periodontograma-dientes-arriba-17.png')} />
        <Row gutter={32}>
